...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2023"), "Partiu viagem", "Vou viajar para Natal!", alex);
		Post post2 = new Post(null, sdf.parse("23/03/2023"), "Buenos días", "Hoy me quedaré em mi casa", alex);
